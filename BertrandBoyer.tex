...
\usepackage[paperheight=37.70cm]{geometry}
...
\begin{document}
  ...
  \hypersetup{
    pdfkeywords = {%
      CV, Curriculum Vit\ae{}, Résumé, Epitech, %
      Innovation, R&D, 10+ years of experiences, %
      Developer, Senior Developer, %
      Java Developer, Senior Java Developer, %
      Software Engineer, Senior Software Engineer, %
      JRE, JDK, Java, Java 8, Java 17, Java 21, Java 25, %
      Spring, Spring Framework, Spring Boot, Springboot, %
      Reactor, RxJava, Jackson, Lombok, %
      JUnit, AssertJ, Mockito, Testcontainers, %
      SQL, PostgreSQL, Hibernate, Flyway, Liquibase, %
      NoSQL, ElasticSearch, MongoDB, ScyllaDB, %
      Gradle, Maven, Git, GitHub, Docker, %
      CI/CD, GitHub Actions, Linux, Bash, Script shell, %
      REST, OpenAPI, JWT, OAuth2, Postman, Bruno, %
      Clean Code, TDD, BDD, DDD, %
      Hexagonal Arch, Architecture Hexagonale, %
      Developer Experience, DX, %
      Agile, Scrum, Kanban, Scrumban, Confluence, Jira, LaTeX, %
