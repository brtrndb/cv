...
% Margin options.
\geometry{top=0.65 cm}                          %% Margin top.
\geometry{bottom=0.65 cm}                       %% Margin bottom.
...
\newcommand{\displayImageEducation}{no}         % Display the images in Education section.
...
\input{./tex/Personal.tex}                      %% Personnal information.
...
\begin{document}
    ...
    \hspace{+2 cm}
    \begin{minipage}[t]{0.42\linewidth}
        \input{./tex/Community.tex}             %% Community section.
    \end{minipage}
\end{document}
