...
\ifthenelse{\equal{\displayEducation}{yes}}{\input{./Education.tex}}
...
\ifthenelse{\equal{\displayExperiences}{yes}}{\input{Experiences.tex}}

%% Skills section.
\newcommand{\displaySkills}{yes}
\ifthenelse{\equal{\displaySkills}{yes}}{\input{Skills.tex}}

%% Section Projets.
\newcommand{\displayProject}{no}
\ifthenelse{\equal{\displayProject}{yes}}{\input{Projects.tex}}{}

%% Languages section.
\newcommand{\displayLanguages}{yes}
\ifthenelse{\equal{\displayLanguages}{yes}}{\input{Languages.tex}}

%% Hobbies section.
\newcommand{\displayHobbies}{yes}
\ifthenelse{\equal{\displayHobbies}{yes}}{\input{Hobbies.tex}}
